			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="login_title">
						<h2>Pendaftaran Pelapak</h2>
					</div>
					@include('errors/pesan_error')
					<div class="login_form">
						<form action="{{url('simpan-pelapak')}}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}	
							<div class="login_input">
								<label>NIK <span>*</span></label>
								<input type="text" name="nik" value='@if(count($errors) > 0){{old('nik')}}@endif' required>
							</div>
							<div class="login_input">
							...
							<div class="login_input">
								...
								<input type="text" name="tempat_lahir" value='@if(count($errors) > 0){{old('tempat_lahir')}}@endif' required>
							</div>
							<div class="login_input">
								<label>Tanggal Lahir <span>*</span></label>
								<input type="date" name="tanggal_lahir" value='@if(count($errors) > 0){{old('tanggal_lahir')}}@endif' required>
							</div>
							<div class="">
