		...
		<div class="col-sm-12">
			<div class="clear panel panel-default">				
				<div class="panel-body">
					<div class="row">
						<form action="{{ url('admin/pelanggan/cari') }}" method="get" enctype="multipart/form-data">
							<div class="col-sm-2">
					...
					<table class="table table-striped table-bordered table-hover table-full-width" id="">
						...
						<tbody>
							...
							<?php 
								$tampil_data = 1;  
								$i = ($pelanggan->currentpage()-1)* $pelanggan->perpage() + 1;
							?>
							...
							@foreach($pelanggan as $p)
								<tr>
									...
									<td>{{$p->alamat}}</td>
									<td>
										<a data-original-title='Detail' class='btn btn-green tooltips' href='{{ url('admin/pelanggan/'. $p->id)}}'>
											<i class='clip-eye'></i>
										</a>
					...
					<div class="row">
						<div class="col-sm-6">
							<h5>Tampil : {{$tampil_data-1}} dari {{count($pelanggan)}} data.</h5>
						</div>
						<div class="col-sm-6" >
