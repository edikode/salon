...
<body>
  ...
  {{-- untuk geser menu atas bawah --}}
  {{-- <script src="{{ asset('admins/plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js') }}"></script> --}}
  
  {{-- untuk form wizard --}}
  {{-- <script src="{{ asset('admins/plugins/jquery-validation/dist/jquery.validate.min.js') }}"></script>
  <script src="{{ asset('admins/plugins/jQuery-Smart-Wizard/js/jquery.smartWizard.js') }}"></script>
  <script src="{{ asset('admins/js/form-wizard.js') }}"></script> --}}

  {{-- select banyak, ganti otomatis --}}
  {{-- <script src="{{ asset('admins/js/jquery.chained.min.js') }}"></script>
  <script>
      $("#startfrom").chained("#regional");
      $("#kategori").chained("#startfrom");
  </script> --}}
