						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div style="width:100%;height:210px;overflow-x:hidden;margin-bottom:10px;">
											@foreach ($kategori as $k)
												...
												@foreach ($parent as $p)
													<label class='checkbox' style="margin-left:25px">
														<input type='checkbox' name='kategori_id' class='square-green' value='{{$p->id}}' @if ($p->id == $paket->kategori_id) checked @endif>
														{{$p->nama}}
													</label>
												@endforeach
											@endforeach
										...
										{{-- <div class="row">
											<div class="col-sm-8">
												<input type="text" placeholder="Tambah Kategori" class="form-control" name="kat">
											</div>
											<div class="col-sm-4">
												<input name="tambahKategori" value="Tambah" type="submit" class="btn btn-green">
											</div>
										</div>														 --}}
									</div>	
								</div>	
										...
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="max-width:334px; max-height:253px; position:relative;">
												<div class="hapus-gambar">
													<a data-original-title="Hapus" data-placement="left" class="btn btn-bricky tooltips" href="{{ url('admin/paket/hapusgambar/'. $paket->id) }}" onclick="return hapusgambar()">
