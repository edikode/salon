		...
		<div class="col-sm-12">
			<div class="clear panel panel-default">				
				<div class="panel-body">
					<div class="row">
						<form action="{{ url('admin/paket/cari') }}" method="get" enctype="multipart/form-data">
							<div class="col-sm-2">
						...
						<tbody>
							...
							@foreach($paket as $p)
								<tr>
									...
									<td>{{$p->deskripsi}}</td>
									<td>
										<a data-original-title='Detail' class='btn btn-green tooltips' href='{{ url('admin/paket/'. $p->id)}}'>
											<i class='clip-eye'></i>
										</a>

										<a data-original-title='Edit' class='btn btn-blue tooltips' href='{{ url('admin/paket/'. $p->id .'/edit')}}'>
											<i class='clip-pencil'></i>
										</a>
										
										<form action="{{url('admin/paket', $p->id)}}" method="post" style="display: inline-block;">
											{{ csrf_field() }}	
	...
	<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-crud">
			<div class="modal-content">
				<form action="{{url('admin/paket')}}" method="post" enctype="multipart/form-data">
