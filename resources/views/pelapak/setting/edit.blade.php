...
@section('title', 'Setting Lapak')

@section('bread')
<li><a href="{{ url('pelapak') }}"><i class="icon-laptop"></i> Home</a></li>
<li class="active">Setting Lapak</li>
@endsection
	...
	<div class="col-sm-12">				
		<div class="panel panel-default">
			<div class="panel-body">	
				<form action="{{ url('pelapak/setting', $setting->id) }}" method="post" enctype="multipart/form-data">				
					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-8">
							<div class='form-group @if($errors->has('nama')) has-error @endif'>
								<label class='control-label'>Nama Lapak</label>
							...
							<div class='form-group'>
								<label class='control-label'>Alamat Lapak</label>
										...
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail" style="max-width:334px; max-height:253px; position:relative;">
												<div class="hapus-gambar">
													<a data-original-title="Hapus" data-placement="left" class="btn btn-bricky tooltips" href="{{ url('pelapak/setting/hapusgambar/'. $setting->id) }}" onclick="return hapusgambar()">
