...
(2, 'Lola Lemots', 'lola@mail.com', '$2y$10$35aXETKkbi9NUrnHrKVH4OgU8huDS2C0VCrNmUBl/6j7qycfhjsSS', 'TpQ3ScR4CCBZBMBzJRjWKKFeEjK4g8FxGnayoVzZ1B79POGYC3HQ0qN3n8sa', 'A1KXiK2tQurNDonL4nSQgGfsQZ8JA8T0InleLKeWCAJgTfszaKlmhYBYdgvSTJw537lcBnKqj8KgNOvKPpaSEJSdbCWXEwLzptlDAJrfReciUOYGhiiYIbnGx7kY9oFm34EwtxgYKjWWKv5lYQQeDBqRJAIxGrIOD4ovbFTMjs8fw3n9YWip9ROUw09bCpWAZv5BglEDZ5aMdjZRVwHbjq8XMfw8Yg6HvgnjyCnSKSgcTtN7R0bFthICTGHIoE9', 'Lola Lemots.jpg', 1, '2018-09-27 18:50:06', '2018-11-10 22:03:04');
...
INSERT INTO `alamat` (`id`, `nama`, `telepon`, `rtrw`, `dusun`, `desa`, `kecamatan`, `kabupaten`, `alamat`, `created_at`, `updated_at`, `pelanggan_id`) VALUES
(9, 'Pelanggan', '081123456789', '03/04', 'Kebaman', 'Srono', 'Srono', 'Banyuwangi', 'Dekat patung tentara sebelah tikungan', '2018-11-26 23:43:14', '2018-11-26 23:43:14', 1);
...
(1, 'Manten Jawa', 'rias-manten', 1, 'Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.', '<p>Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.</p>\r\n', 500000, 'rias-manten.jpg', 0, 1, '2018-09-28', '2018-11-24', 1),
(2, 'Rias Manten - Lola salon', 'rias-manten-lola-salon', 1, 'Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.', '<p>Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.</p>\r\n', 600000, 'rias-manten-lola-salon.png', 0, 1, '2018-11-24', '2018-11-24', 1),
(3, 'Hijab Manten', 'hijab-manten', 1, 'Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.', '<p>Rias manten 1 pasang, untuk acara pengantenan dengan memakai baju adat manten jawa. Rias lengkap dengan baju.</p>\r\n', 600000, 'hijab-manten.png', 0, 1, '2018-11-24', '2018-11-24', 1);
...
INSERT INTO `pelanggan` (`id`, `nama`, `email`, `password`, `telepon`, `tempat_lahir`, `tanggal_lahir`, `gambar`, `status`, `remember_token`, `activation_token`, `created_at`, `updated_at`) VALUES
(5, 'eday', 'eday@mail.com', '$2y$10$ho4PxzsyyH/V5HJzKfKdJeQZlZnsJY6vHnI8yfqwFk5lFKL.ygNf6', '0812345678', NULL, NULL, NULL, 1, '4lcndf9gg6C4K9pfahTfVtpRvVFWEA62wth87cF9AVi1OQIo2oCDihyjs5dR', 'EQA6WH1oljapKPaXfMCkkOL6i9m9U6E7WVjavWX0SjW7hRXR0BiN5P5FSa7Es7Ubkt0OqiN84ahQLaaznS0BHdM1RSYKG3pcgDZa7RPCa2WxRP2i3T8KHM06usmFz7cBkCLISJUTnkdfehMKK29yrmdQE2FEuQgWVJHaTV2ZAzz7JFBl3Pj1cXenJI4LFcE1FjtMl6Wnm95M0gStOnyIl7asrh6MswcVjoTEQyCR6YJq2chbYtk8VLkE0R148Fj', '2018-11-24 19:33:50', '2018-11-27 08:23:31');
...
(1, '1234567891234567', 'Pelapak', 'pelapak@mail.com', '$2y$10$EQvdODCF1FDb9TGIum.2wOFD9fDQjD8gomu442n0cySeqS1wMqcIC', '081123456789', 'Banyuwangi', '1997-11-02', 'Banyuwangi desa baru', 'Pelapak.jpeg', 1, 'PZKLGp7SdcpmhGnvSyfAz0Ij42EOgx396llf1V9caTrRjYWG9jsMTyhINo81', NULL, '2018-09-19 17:00:00', '2018-11-10 23:18:49'),
...
INSERT INTO `pemesanan` (`id`, `tanggal_rias`, `jam_mulai`, `total`, `keterangan`, `status`, `alamat_id`, `created_at`, `updated_at`, `pelanggan_id`, `paket_id`) VALUES
('6727', '2018-11-27 17:00:00', 8, 500239, NULL, 1, 9, '2018-11-26 23:43:14', '2018-11-26 23:43:14', 1, 3);
...
(1, 'Saline APP', 'ds. Srono kec. Srono 68411 kab. Banyuwangi - Jawa Timur', '081123456789', 'saline.app@mail.com', '', 'Saline APP.png', NULL, '2018-02-23', '2018-09-20', 2);
...
ALTER TABLE `pemesanan`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `kode_UNIQUE` (`id`),
  ADD KEY `fk_pemesanan_pelanggan1` (`pelanggan_id`),
  ADD KEY `fk_pemesanan_paket_rias1` (`paket_id`);
...
--
ALTER TABLE `konfirmasi_pelanggan`
  ADD CONSTRAINT `fk_konfirmasi_pelanggan_pemesanan1` FOREIGN KEY (`pemesanan_kode`) REFERENCES `pemesanan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `konfirmasi_pelapak`
--
ALTER TABLE `konfirmasi_pelapak`
  ADD CONSTRAINT `fk_konfirmasi_ps_pemesanan1` FOREIGN KEY (`pemesanan_kode`) REFERENCES `pemesanan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `pembayaran`
  ...
  ADD CONSTRAINT `fk_pembayaran_pemesanan1` FOREIGN KEY (`pemesanan_kode`) REFERENCES `pemesanan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `pemesanan`
  ADD CONSTRAINT `fk_pemesanan_paket_rias1` FOREIGN KEY (`paket_id`) REFERENCES `paket` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `review`
  ADD CONSTRAINT `fk_review_pemesanan1` FOREIGN KEY (`pemesanan_kode`) REFERENCES `pemesanan` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
